...
const migrations_1 = require("./config/migrations/migrations");
...
const startServer = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        exports.app.listen(constants_1.constants.port, () => {
            logger_1.logger.info("server started successfully on " + constants_1.constants.port);
            ...
            try {
                ...
                logger_1.logger.info("process.send defined");
            }
            catch (error) {
                console.log("process.send not defined");
                logger_1.logger.error("process.send not defined.");
            }
        });
    }
    catch (error) {
